...
//URPlataform.Web
{
    ...
    public class CuentaController : Controller
    {
        ...
        public CuentaController(AnubisDBMSUserManager userManager, AnubisDBMSSignInManager signInManager)
        {
            UserManager = userManager;
            SignInManager = signInManager;
        }

        public AnubisDBMSSignInManager SignInManager
        {
            get => _signInManager ?? HttpContext.GetOwinContext().Get<AnubisDBMSSignInManager>();
        ...
        [AllowAnonymous]
        public async Task<ActionResult> ConfirmarEmail(long userId, string code)
        {
            ...
            string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new AnubisDBMSUser {UserName = model.Email, Email = model.Email};
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("IniciarSesion", "Cuenta", new {area = "Seguridad"});
        }
